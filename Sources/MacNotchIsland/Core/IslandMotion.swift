...
enum IslandMotion {
    ...
    static var open: Animation { reduceMotion ? .easeOut(duration: 0.18) : .spring(response: 0.42, dampingFraction: 0.68, blendDuration: 0) }
    static var close: Animation { reduceMotion ? .easeOut(duration: 0.16) : .spring(response: 0.34, dampingFraction: 0.84, blendDuration: 0) }
