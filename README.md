...
| — | Controls: the networks in range and the devices you are paired with, each with its own switch. Join a known network or connect a pair of headphones without opening System Settings. |
