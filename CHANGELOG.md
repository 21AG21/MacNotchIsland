...
- **With a film full screen on one display, a panel opened from the shortcut or the menu bar gives the keyboard to the island you can see**, not to the hidden one over the film, so the film keeps its focus and Space no longer pauses the music.
