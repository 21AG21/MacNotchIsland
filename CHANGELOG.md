...
- **All your Actions fit.** With six apps only two of eight favourite Shortcuts were drawn, and the Home tile counted them all. The row holds ten, Settings counts apps and Shortcuts against it together, and the tile counts what the row draws; an app on a disk that is not plugged in takes no room in Settings' count either.
